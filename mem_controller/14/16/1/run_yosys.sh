...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 14 -set DATA_TYPE 16 -set ADDR_TYPE 1 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/14/16/1/mem_controller_14_16_1_yosys.blif" > /dev/null
