...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 7 -set DATA_TYPE 14 -set ADDR_TYPE 28 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/7/14/28/mem_controller_7_14_28_yosys.blif" > /dev/null
