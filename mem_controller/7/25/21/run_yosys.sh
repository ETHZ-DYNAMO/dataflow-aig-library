...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 7 -set DATA_TYPE 25 -set ADDR_TYPE 21 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/7/25/21/mem_controller_7_25_21_yosys.blif" > /dev/null
