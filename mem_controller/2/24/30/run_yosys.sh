...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 2 -set DATA_TYPE 24 -set ADDR_TYPE 30 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/2/24/30/mem_controller_2_24_30_yosys.blif" > /dev/null
