...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 11 -set DATA_TYPE 15 -set ADDR_TYPE 3 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/11/15/3/mem_controller_11_15_3_yosys.blif" > /dev/null
