...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 11 -set DATA_TYPE 5 -set ADDR_TYPE 14 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/11/5/14/mem_controller_11_5_14_yosys.blif" > /dev/null
