...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 8 -set DATA_TYPE 31 -set ADDR_TYPE 30 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/8/31/30/mem_controller_8_31_30_yosys.blif" > /dev/null
