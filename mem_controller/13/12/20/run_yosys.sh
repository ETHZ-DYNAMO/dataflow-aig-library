...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 13 -set DATA_TYPE 12 -set ADDR_TYPE 20 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/13/12/20/mem_controller_13_12_20_yosys.blif" > /dev/null
