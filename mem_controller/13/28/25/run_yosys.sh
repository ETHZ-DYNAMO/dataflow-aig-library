...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 13 -set DATA_TYPE 28 -set ADDR_TYPE 25 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/13/28/25/mem_controller_13_28_25_yosys.blif" > /dev/null
