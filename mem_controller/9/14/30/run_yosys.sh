...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 9 -set DATA_TYPE 14 -set ADDR_TYPE 30 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/9/14/30/mem_controller_9_14_30_yosys.blif" > /dev/null
