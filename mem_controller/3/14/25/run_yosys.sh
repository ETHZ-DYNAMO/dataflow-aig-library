...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 3 -set DATA_TYPE 14 -set ADDR_TYPE 25 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/3/14/25/mem_controller_3_14_25_yosys.blif" > /dev/null
