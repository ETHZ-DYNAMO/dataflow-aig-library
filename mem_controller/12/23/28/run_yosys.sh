...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 12 -set DATA_TYPE 23 -set ADDR_TYPE 28 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/12/23/28/mem_controller_12_23_28_yosys.blif" > /dev/null
