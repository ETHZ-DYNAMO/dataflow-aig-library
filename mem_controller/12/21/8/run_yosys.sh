...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 12 -set DATA_TYPE 21 -set ADDR_TYPE 8 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/12/21/8/mem_controller_12_21_8_yosys.blif" > /dev/null
