...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 5 -set DATA_TYPE 10 -set ADDR_TYPE 17 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/5/10/17/mem_controller_5_10_17_yosys.blif" > /dev/null
