...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 15 -set DATA_TYPE 7 -set ADDR_TYPE 19 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/15/7/19/mem_controller_15_7_19_yosys.blif" > /dev/null
