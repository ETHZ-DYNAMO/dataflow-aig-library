...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 15 -set DATA_TYPE 27 -set ADDR_TYPE 20 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/15/27/20/mem_controller_15_27_20_yosys.blif" > /dev/null
