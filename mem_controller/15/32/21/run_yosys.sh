...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 15 -set DATA_TYPE 32 -set ADDR_TYPE 21 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/15/32/21/mem_controller_15_32_21_yosys.blif" > /dev/null
