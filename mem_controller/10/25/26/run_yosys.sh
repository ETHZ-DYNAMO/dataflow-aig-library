...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/mem_controller_storeless.v
        ...
        chparam -set NUM_LOADS 10 -set DATA_TYPE 25 -set ADDR_TYPE 26 mem_controller
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/mem_controller/10/25/26/mem_controller_10_25_26_yosys.blif" > /dev/null
