...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/dataless/control_merge.v
        ...
        chparam -set SIZE 7 -set INDEX_TYPE 2 control_merge_dataless
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/control_merge_dataless/7/2/control_merge_dataless_7_2_yosys.blif" > /dev/null
