...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/dataless/control_merge.v
        ...
        chparam -set SIZE 8 -set INDEX_TYPE 3 control_merge_dataless
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/control_merge_dataless/8/3/control_merge_dataless_8_3_yosys.blif" > /dev/null
