...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/dataless/control_merge.v
        ...
        chparam -set SIZE 3 -set INDEX_TYPE 1 control_merge_dataless
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/control_merge_dataless/3/1/control_merge_dataless_3_1_yosys.blif" > /dev/null
