...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/dataless/control_merge.v
        ...
        chparam -set SIZE 2 -set INDEX_TYPE 1 control_merge_dataless
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/control_merge_dataless/2/1/control_merge_dataless_2_1_yosys.blif" > /dev/null
