...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 5 -set DATA_TYPE 26 -set INDEX_TYPE 3 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/5/26/3/control_merge_5_26_3_yosys.blif" > /dev/null
