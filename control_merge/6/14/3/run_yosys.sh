...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 6 -set DATA_TYPE 14 -set INDEX_TYPE 3 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/6/14/3/control_merge_6_14_3_yosys.blif" > /dev/null
