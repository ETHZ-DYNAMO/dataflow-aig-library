...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 6 -set DATA_TYPE 12 -set INDEX_TYPE 3 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/6/12/3/control_merge_6_12_3_yosys.blif" > /dev/null
