...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 8 -set DATA_TYPE 5 -set INDEX_TYPE 1 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/8/5/1/control_merge_8_5_1_yosys.blif" > /dev/null
