...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 8 -set DATA_TYPE 16 -set INDEX_TYPE 3 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/8/16/3/control_merge_8_16_3_yosys.blif" > /dev/null
