...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 3 -set DATA_TYPE 2 -set INDEX_TYPE 1 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/3/2/1/control_merge_3_2_1_yosys.blif" > /dev/null
