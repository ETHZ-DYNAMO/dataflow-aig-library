...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 3 -set DATA_TYPE 7 -set INDEX_TYPE 2 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/3/7/2/control_merge_3_7_2_yosys.blif" > /dev/null
