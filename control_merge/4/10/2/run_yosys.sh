...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 4 -set DATA_TYPE 10 -set INDEX_TYPE 2 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/4/10/2/control_merge_4_10_2_yosys.blif" > /dev/null
