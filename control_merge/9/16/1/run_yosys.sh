...
yosys -p "read_verilog -defer /home/ubuntu/aig_generation/data/verilog/handshake/control_merge.v
        ...
        chparam -set SIZE 9 -set DATA_TYPE 16 -set INDEX_TYPE 1 control_merge
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/aig_generation/data/blif/control_merge/9/16/1/control_merge_9_16_1_yosys.blif" > /dev/null
