...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/shift_reg_break_dv.v
        ...
        chparam -set NUM_SLOTS 1 -set DATA_TYPE 26 shift_reg_break_dv
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/shift_reg_break_dv/1/26/shift_reg_break_dv_1_26_yosys.blif" > /dev/null
