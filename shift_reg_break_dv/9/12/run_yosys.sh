...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/shift_reg_break_dv.v
        ...
        chparam -set NUM_SLOTS 9 -set DATA_TYPE 12 shift_reg_break_dv
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/shift_reg_break_dv/9/12/shift_reg_break_dv_9_12_yosys.blif" > /dev/null
