...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/shift_reg_break_dv.v
        ...
        chparam -set NUM_SLOTS 8 -set DATA_TYPE 18 shift_reg_break_dv
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/shift_reg_break_dv/8/18/shift_reg_break_dv_8_18_yosys.blif" > /dev/null
