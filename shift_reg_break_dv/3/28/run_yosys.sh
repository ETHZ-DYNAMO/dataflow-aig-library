...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/shift_reg_break_dv.v
        ...
        chparam -set NUM_SLOTS 3 -set DATA_TYPE 28 shift_reg_break_dv
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/shift_reg_break_dv/3/28/shift_reg_break_dv_3_28_yosys.blif" > /dev/null
