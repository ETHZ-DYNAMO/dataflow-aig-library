...
yosys -p "read_verilog -defer /home/ubuntu/dynamatic/data/verilog/handshake/shift_reg_break_dv.v
        ...
        chparam -set NUM_SLOTS 3 -set DATA_TYPE 10 shift_reg_break_dv
        ...
        flatten;
        clean;
        write_blif /home/ubuntu/dynamatic/data/aig/shift_reg_break_dv/3/10/shift_reg_break_dv_3_10_yosys.blif" > /dev/null
